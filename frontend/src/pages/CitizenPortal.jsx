  ...
  const handleSubmitReport = async (e) => {
    ...
    try {
      ...
      await addReport({
        ...
        chuyen_muc: reportCategory,
        linh_vuc: reportField,
            ...
            <form onSubmit={handleSubmitReport}>
              <div className="grid-2" style={{ gap: '1rem', marginBottom: '1rem' }}>
                ...
                <div className="input-group" style={{ marginBottom: 0 }}>
                  ...
                  <select className="input-field" value={reportForm} onChange={e => setReportForm(e.target.value)} required>
              ...
              <div className="grid-2" style={{ gap: '1rem', marginBottom: '1rem' }}>
                <div className="input-group" style={{ marginBottom: 0 }}>
                  <label className="input-label">Chuyên mục *</label>
                  <select className="input-field" value={reportCategory} onChange={e => setReportCategory(e.target.value)} required>
                    <option>Lĩnh vực môi trường</option>
                    <option>Lĩnh vực an ninh trật tự</option>
                    <option>Lĩnh vực giao thông</option>
                    <option>Lĩnh vực hạ tầng</option>
                  </select>
                </div>
                <div className="input-group" style={{ marginBottom: 0 }}>
                  <label className="input-label">Lĩnh vực cụ thể *</label>
                  <input type="text" className="input-field" value={reportField} onChange={e => setReportField(e.target.value)} required />
                </div>
              </div>
              ...
              <div className="grid-2" style={{ gap: '1rem', marginBottom: '1rem' }}>
                <div className="input-group" style={{ marginBottom: 0 }}>
                  ...
                  <select className="input-field" value={reportWard} onChange={e => setReportWard(e.target.value)} required>
                ...
                <div className="input-group" style={{ marginBottom: 0 }}>
                  <label className="input-label">Vị trí (Địa chỉ cụ thể) *</label>
                  <input type="text" className="input-field" placeholder="Ví dụ: 123 Đường A" value={reportAddress} onChange={e => setReportAddress(e.target.value)} required />
                </div>
              </div>
              <div className="input-group">

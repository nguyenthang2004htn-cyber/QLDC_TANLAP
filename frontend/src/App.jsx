...
function AppRoutes() {
  ...
  return (
    <Routes>
      <Route path="/login" element={user ? <Navigate to={user.role === 'superadmin' ? '/system-admin' : user.role === 'admin' ? '/admin' : user.role === 'official' ? '/official' : '/citizen'} replace /> : <Login />} />
      ...
      <Route path="/" element={
        user ? <Navigate to={user.role === 'superadmin' ? '/system-admin' : user.role === 'admin' ? '/admin' : user.role === 'official' ? '/official' : '/citizen'} replace /> : <Navigate to="/login" replace />
      } />
